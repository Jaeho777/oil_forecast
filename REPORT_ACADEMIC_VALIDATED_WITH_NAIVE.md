...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| WTI Oil | 6.300 | 5.379 | 15.952 | 16.656 | 17.370 | -0.921 |
| Brent Oil | 5.516 | 4.786 | 15.307 | 15.471 | 16.038 | -0.730 |
...
- residual 보정모델(`NLinear`, `XGB`, `LGBM`)은 `Naive`와 `PatchTST`를 모두 안정적으로 상회하지 못했다.
